...
function calculateRouteFromAtoB (platform, waypoint0, waypoint1) {
  ...
  function onSuccess(result) {
    if ('response' in result && 'route' in result['response'] && result['response']['route'].length) {
  ...
  var map = new H.Map(mapContainer,
    ...
    center: {lat:48.7931, lng:55.7951},
    zoom: 13,
  ...
  var pairs = $map_element.data('pairs');

  pairs.forEach(function(pair) {
    var 
      waypoint0 = pair['from_longitude'] + ',' + pair['from_latitude'],
      waypoint1 = pair['to_longitude'] + ',' + pair['to_latitude'];
